...
import { createBriefingTemplate } from '@/actions/briefing';
...
export default function BriefingForm() {
  ...
  return (
    <form action={createBriefingTemplate} onSubmit={() => setLoading(true)}>
      <div className={styles.profileSection}>
        <h3 className={styles.sectionTitle}>Título do Template</h3>
        <div className={styles.formGroup}>
          <input type="text" name="titulo" required className={styles.input} placeholder="Ex: Criação de E-commerce" />
        </div>
      </div>
